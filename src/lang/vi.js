export default {
  ...
  table: {
    ...
    point: 'Point',
    is_chicken_option_group: 'Is Chicken',
    key: 'Key',
    value: 'Value',
    ip: 'IP',
  ...
  order: 'Thu ngân',
  customer: 'Khách hàng',
  orderList: 'Danh sách hóa đơn',
  revenueReport: 'Báo cáo hàng ngày',
  employeeList: 'Danh sách nhân viên',
  productInventory: 'Nhập xuất kho hàng',
  businessProfile: 'Thông tin chung',
  businessBrand: 'Quản lý chi nhánh',
